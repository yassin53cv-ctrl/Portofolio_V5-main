  ...
  itemType="https://schema.org/Person"
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
        yassin khaled, Front-End Web Developer iam 17 year old web desighner and software develepor and Front-end.
        </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://wa.me/201022950178" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
              ...
              >
                <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> contact me
              </button>
              </a>
              <a href="https://www.instagram.com/i2enaa" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="1000"
              ...
              >
                <Code className="w-4 h-4 sm:w-5 sm:h-5" /> Instagram
              </button>
              </a>
            </div>
          </div>
        ...
        {/* Stats grid - removed outer <a> wrapper */}
      ...
      <footer className="absolute bottom-8 text-gray-500 text-sm">
        © 2026 yassin. All Rights Reserved.
      </footer>
    </div>
  );
};
